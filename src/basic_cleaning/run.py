...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help = "Name of the artifact for preprocessing", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str, ## INSERT TYPE HERE: str, float or int,
        help = "Name of clean artifact",## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str, ## INSERT TYPE HERE: str, float or int,
        help = "Description of preprocessed data",## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        ...
        help = "Minimum price allowed for prediction column",## INSERT DESCRIPTION HERE,
        required = True
    )
